...
def chatbot_response(msg):
    ...
    # If intent is "goodbye", clear context
    if ints[0]["intent"] == "goodbye":
        context.clear()

    # If intent is "get_name", save user's name in context
    if ints[0]["intent"] == "get_name":
        context["name"] = msg

    # If intent is "get_city", save user's city in context
    if ints[0]["intent"] == "get_city":
        context["city"] = msg

    # If intent is "get_weather", check if user's name and city are in context
